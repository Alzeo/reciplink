...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.oejvuYw' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_OejvuYwService()
    {
        return $this->privates['.service_locator.oejvuYw'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\LoveController::love' => ['privates', '.service_locator.g_QAUHN', 'get_ServiceLocator_GQAUHNService', false],
