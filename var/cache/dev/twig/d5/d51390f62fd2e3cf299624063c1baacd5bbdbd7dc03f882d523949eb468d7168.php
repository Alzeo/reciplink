...
class __TwigTemplate_22ebaf63a98de3138df740526be56f09b83fb4adb38149f5b86dabc2aedf508d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <section class=\"howWork text-center container-fluid\" style=\"padding-top: 40px; padding-bottom: 40px; width: 80%;\">
        <h4 CLASS=\"mb-5\">TOUTES LES RECETTES</h4>
        <div class=\"jumbotron\">
            ";
        // line 14
        ...
        echo "
                ...
                <div class=\"col-xs-12 col-md-6 col-lg-4\">
                    ";
        // line 20
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 20, $this->source); })()), "regime", [], "any", false, false, false, 20), 'row');
        echo "
                </div>
                <div class=\"col-xs-12 col-md-6 col-lg-4\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["recipe"]) {
            // line 30
            echo "                    ";
            $this->loadTemplate("recipe/_recipe.html.twig", "main/discover.html.twig", 30)->display($context);
            // line 31
            echo "                ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return array (  163 => 34,  159 => 32,  145 => 31,  142 => 30,  125 => 29,  119 => 26,  110 => 20,  104 => 17,  98 => 14,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
