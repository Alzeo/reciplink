...
class __TwigTemplate_7fae2201d355d3c182cc0fe59370125f0a5b88aed1c86fa256d46796c502b6e8 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ";
            ...
            if ((isset($context["previous"]) || array_key_exists("previous", $context))) {
                ...
                echo "\"><i aria-hidden=\"true\" class=\"fa fa-angle-left\"></i></a>
                </li>
            ";
            } else {
                // line 23
                echo "                <li class=\"page-item disabled\">
                    <span class=\"page-link\"><i aria-hidden=\"true\" class=\"fa fa-angle-left\"></i></span>
                </li>
            ";
            }
            // line 27
...
(isset($context["startPage"]) || array_key_exists("startPage", $context) ? $context["startPage"] : (function () { throw new RuntimeError('Variable "startPage" does not exist.', 36, $this->source); })()) != 2)) {
            ...
            if ((isset($context["next"]) || array_key_exists("next", $context))) {
                ...
                echo "\"><i aria-hidden=\"true\" class=\"fa fa-angle-right\"></i></a>
                </li>
            ";
            } else {
                // line 78
                echo "                <li  class=\"page-item disabled\">
                    <span class=\"page-link\"><i aria-hidden=\"true\" class=\"fa fa-angle-right\"></i></span>
                </li>
            ";
            }
            // line 82
    ...
    <nav>
        ...
        <ul class=\"pagination{{ classAlign }}{{ classSize }}\">
            ...
            {% if previous is defined %}
                <li class=\"page-item\">
                    <a class=\"page-link\" rel=\"prev\" href=\"{{ path(route, query|merge({(pageParameterName): previous})) }}\"><i aria-hidden=\"true\" class=\"fa fa-angle-left\"></i></a>
                </li>
            {% else %}
            ...
            {% if next is defined %}
                <li class=\"page-item\">
                    <a class=\"page-link\" rel=\"next\" href=\"{{ path(route, query|merge({(pageParameterName): next})) }}\"><i aria-hidden=\"true\" class=\"fa fa-angle-right\"></i></a>
                </li>
            {% else %}
                <li  class=\"page-item disabled\">
                    <span class=\"page-link\"><i aria-hidden=\"true\" class=\"fa fa-angle-right\"></i></span>
