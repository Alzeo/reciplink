    ...
    <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["recipe"]) {
            ...
            echo "</h2>
                    <img src=\"";
            // line 37
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/recipes/" . twig_get_attribute($this->env, $this->source, $context["recipe"], "picture", [], "any", false, false, false, 37))), "html", null, true);
            echo "\" alt=\"\" style=\"max-width: 100%\"/>
                    <p class=\"extract text-center\"><i class=\"fa fa-thumbs-up\"></i> ";
            // line 38
            echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["recipe"], "likes", [], "any", false, false, false, 38)), "html", null, true);
            echo "
                        <i class=\"fa fa-comments\"></i> ";
            // line 39
            echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["recipe"], "commentRecipe", [], "any", false, false, false, 39)), "html", null, true);
            echo "</p>
                    <a href=\"";
            // line 40
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("recipe_show", ["slug" => twig_get_attribute($this->env, $this->source, $context["recipe"], "slug", [], "any", false, false, false, 40)]), "html", null, true);
...
";
    ...
    {
        return array (  184 => 43,  175 => 40,  171 => 39,  167 => 38,  163 => 37,  159 => 36,  156 => 35,  152 => 34,  148 => 32,  138 => 28,  134 => 27,  130 => 26,  126 => 25,  123 => 24,  119 => 23,  111 => 18,  101 => 11,  97 => 10,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "posts/show.html.twig", "/home/cortez/Sites/reciplink/templates/posts/show.html.twig");
    }
}
