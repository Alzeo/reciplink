...
class __TwigTemplate_8b881cdc6c1ca90c2d4c3e0d3b5149c9a38c621d467ecaff192f75df8514b351 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"jumbotron text-center\" style=\"background-image: url(";
        ...
        <div class=\"typography-line\"><h2>Découvrez de nouvelles recettes</h2></div>
        <p>Voici toutes les recettes proposés par nos utilisateurs, régalez vous !</p>
    </div>
    <section class=\"howWork text-center container-fluid\" style=\"padding-top: 40px; padding-bottom: 40px; width: 80%;\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["recipes"]) || array_key_exists("recipes", $context) ? $context["recipes"] : (function () { throw new RuntimeError('Variable "recipes" does not exist.', 31, $this->source); })()));
        $context['loop'] = [
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["recipe"]) {
            // line 32
            echo "                    ";
            $this->loadTemplate("recipe/_recipe.html.twig", "main/discover.html.twig", 32)->display($context);
            // line 33
            echo "                ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
        ...
        <div class=\"pagination justify-content-center\">
            ";
        // line 36
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["recipes"]) || array_key_exists("recipes", $context) ? $context["recipes"] : (function () { throw new RuntimeError('Variable "recipes" does not exist.', 36, $this->source); })()));
        echo "
        </div>
    </section>
";
    ...
    {
        return array (  168 => 36,  164 => 34,  150 => 33,  147 => 32,  130 => 31,  124 => 28,  115 => 22,  109 => 19,  103 => 16,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "main/discover.html.twig", "/Users/tomaccess/Documents/Sites/reciplink/templates/main/discover.html.twig");
    }
}
